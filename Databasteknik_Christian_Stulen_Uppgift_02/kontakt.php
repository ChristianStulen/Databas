...
<div class="container">
    ...
    <div>
        ...
        <div class="row text-center">
            <div class="col-md">
                <div class="">
                    <img class="mx-auto rounded-circle img-fluid" src="img/team/a.jpg" alt="">
            ...
            <div class="col-md">
                <div class="">
                    <img class="mx-auto rounded-circle img-fluid" src="img/team/c.jpg" alt="">
            ...
            <form novalidate action="<?php echo htmlspecialchars('#'); ?>" method="post" class="row">
                <div class="form-group col-md-4">
                    ...
                    <select name="mottagare" id="mottagare" class="form-control">
                        ...
                        <option value="Annika Rengfelt">Annika Rengfelt</option>
                        <option value="Christian Stulen">Christian Stulen</option>
                    </select>
                </div>
